        ...
        <div class="col-lg-11 col-xl-10">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                <h2 class="history-title mb-0" style="font-size: 1.5rem; font-weight: 700; color: #1e3c72;">
                    <i class="fas fa-plus-circle text-primary me-2"></i> Tambah Menu Makanan
                </h2>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-7">
                    <div class="card h-100 shadow-sm border-0 p-4" style="border-radius: 20px; background: #ffffff;">
                        <form enctype="multipart/form-data" method="POST" action="{{ route('menus.store') }}" class="d-flex flex-column gap-4 h-100">
                            @csrf

                            <div>
                                <label for="nama" class="form-label fw-bold text-dark mb-2" style="font-size: 0.85rem;">Nama Menu</label>
                                <input id="nama" class="form-control" type="text" name="nama" placeholder="Masukkan nama makanan/minuman..." value="{{ old('nama') }}" required />
                            </div>

                            <div>
                                <label for="deskripsi" class="form-label fw-bold text-dark mb-2" style="font-size: 0.85rem;">Deskripsi Menu</label>
                                <textarea id="deskripsi" class="form-control" name="deskripsi" placeholder="Tuliskan deskripsi lengkap menu..." rows="4">{{ old('deskripsi') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="harga" class="form-control border-start-0" type="text" name="harga" placeholder="Contoh: 15.000" style="border-radius: 0 12px 12px 0;" value="{{ old('harga') }}" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <span class="text-muted small d-block mt-1" style="font-size: 0.72rem; font-weight: 500;">Format gambar yang didukung: JPG, JPEG, PNG. Maksimal 2MB.</span>
                            </div>

                            <div class="mt-auto pt-3">
                                <button type="submit" class="btn btn-primary w-100 py-2.5 rounded-pill" style="font-size: 0.9rem; font-weight: 600;">
                                    <i class="fas fa-save me-1.5"></i> Simpan Menu Baru
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="card h-100 shadow-sm border-0 p-4 text-center d-flex flex-column align-items-center justify-content-center" style="border-radius: 20px; background: #ffffff; min-height: 380px;">
                        <h5 class="fw-bold text-dark mb-3" style="font-size: 0.95rem;">Pratinjau Gambar</h5>
                        <div class="preview-img-container mb-3 shadow-sm" style="width: 240px; height: 240px; border-radius: 16px; overflow: hidden; border: 2px dashed rgba(13, 110, 253, 0.15); background: #f8fafc; display: flex; align-items: center; justify-content: center;">
                            <img id="preview" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover;" src="{{ url('storage/noimage.png') }}" onerror="this.src='{{ url('storage/noimage.png') }}'">
                        </div>
                        <p class="text-muted small px-3 mb-0" style="font-size: 0.75rem; max-width: 280px; font-weight: 500;">
                            Gambar di atas menunjukkan pratinjau foto menu Anda. Pastikan gambar jelas dan memiliki rasio yang seimbang.
                        </p>
                    </div>
                </div>
            </div>
