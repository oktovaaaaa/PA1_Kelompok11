    ...
    <div class="row justify-content-center">
        <div class="col-lg-11 mt-4">
            <form action="" method="GET" class="d-flex">
                <input type="text" name="search" class="form-control me-2" placeholder="Cari menu..." value="">
                        ...
                        <div class="col" data-menu-id="{{ $menu->id }}">
                            <div class="card h-100 shadow-sm rounded-4 overflow-hidden" style="max-width: 250px; margin: auto;">
                                ...
                                <div class="card-body d-flex flex-column" style="padding: 0.75rem;">
                                    ...
                                    <button type="button" class="btn btn-primary pesanMenuBtn" data-menu-id="{{ $menu->id }}" data-bs-toggle="modal" data-bs-target="#confirmOrderModal" style="font-size: 0.8rem; padding: 0.3rem 0.6rem;">Pesan</button>
                                </div>
                            </div>
                        </div>
