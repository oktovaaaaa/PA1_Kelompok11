...
@section('title', 'DelCafe - Tambah Testimoni')
        ...
        <div class="testimoni-card-container">
            ...
            <div class="testimoni-card">
                <div class="testimoni-header text-center">
                    ...
                    <p class="text-muted small mb-0">Bagikan pengalaman berkesan Anda di Del Cafe</p>
                </div>

                <form action="{{ route('testimoni.store') }}" method="POST" id="testimoniForm" class="mt-3">
                    @csrf
                    ...
                    <div class="rating-group text-center mb-3">
                        <label class="rating-label mb-1">Beri Rating Ulasan Anda</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-control" rows="3" placeholder="Tuliskan pengalaman kuliner Anda di sini..." required></textarea>
                    </div>
